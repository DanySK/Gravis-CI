...
MAVEN_DOWNLOAD_URL="http://mirror.nohup.it/apache/maven/maven-3/${MAVEN_VERSION}/binaries/${MAVEN_TARBALL}.tar.gz"
MAVEN_INSTALLER_LOCATION="${MAVEN_INSTALL_FOLDER}/apache-maven-${MAVEN_VERSION}-bin.tar.gz"
